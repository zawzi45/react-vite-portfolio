...
export const MobileMenu = ({ menuOpen, setMenuOpen }) => {
  ...
  focus:outline-none cursor-pointer"
			...
			<a
				href="#home"
				onClick={() => setMenuOpen(false)}
				className={`text-2xl font-semeibold text-white my-4 transform transition-transform duration-300 
   ${menuOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-x-5"}`}
			>
				Home
			</a>
			<a
